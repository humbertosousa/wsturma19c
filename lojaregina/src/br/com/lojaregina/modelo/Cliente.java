 ...
 * - Deve possuir dois construtores no mínimo, onde um deles deve estar
 * vazio (sem parâmetros) e o outro cheio que deve estar completo (com todos os
 * parâmetros para o preenchimento dos atributos).
 * 
